                            ...
                            cairo_pdf_version_t *version)
{
  ...
  PLGI_debug("    term: 0x%lx  --->  cairo_pdf_version_t: %p", t, version);
                            ...
                            term_t              t)
{
  ...
  PLGI_debug("    cairo_pdf_version_t: %d  --->  term: 0x%lx", version, t);
...
PLGI_PRED_IMPL(plcairo_pdf_get_versions)
{
...
PLGI_PRED_IMPL(plcairo_pdf_surface_create)
{
...
PLGI_PRED_IMPL(plcairo_pdf_surface_create_for_stream)
{
  term_t t_stream = FA0;
  term_t t_width_in_points = FA1;
  term_t t_height_in_points = FA2;
...
PLGI_PRED_IMPL(plcairo_pdf_surface_restrict_to_version)
{
...
PLGI_PRED_IMPL(plcairo_pdf_surface_set_size)
{
  term_t t_surface = FA0;
  term_t t_width_in_points = FA1;
  term_t t_height_in_points = FA2;
...
PLGI_PRED_IMPL(plcairo_pdf_version_to_string)
{
...
PLGI_PRED_IMPL(plcairo_pdf_get_versions)
{ return plgi_raise_error("cairo_pdf_get_versions/1 not supported");
}

PLGI_PRED_IMPL(plcairo_pdf_surface_create)
{ return plgi_raise_error("cairo_pdf_surface_create/4 not supported");
}

PLGI_PRED_IMPL(plcairo_pdf_surface_create_for_stream)
{ return plgi_raise_error("cairo_pdf_surface_create_for_stream/4 not supported");
}

PLGI_PRED_IMPL(plcairo_pdf_surface_restrict_to_version)
{ return plgi_raise_error("cairo_pdf_surface_restrict_to_version/2 not supported");
}

PLGI_PRED_IMPL(plcairo_pdf_surface_set_size)
{ return plgi_raise_error("cairo_pdf_surface_set_size/3 not supported");
}

PLGI_PRED_IMPL(plcairo_pdf_version_to_string)
{ return plgi_raise_error("cairo_pdf_version_to_string/2 not supported");
}
